...
exports.index = function (req, res, next) {
  ...
  if (topic_id.length !== 24) {
    return res.render404('This topic does not exist or has been deleted');
  }
...
exports.put = function (req, res, next) {
  ...
  var editError;
  if (title === '') {
    editError = 'Heading cannot be blank.';
  } else if (title.length < 5 || title.length > 100) {
    editError = 'Heading has too many or too few words.';
  } else if (!tab || allTabs.indexOf(tab) === -1) {
    editError = 'You need to select a section.';
  } else if (content === '') {
    editError = 'The content cannot be blank.';
  }
  // END 验证
...
exports.showEdit = function (req, res, next) {
  ...
  Topic.getTopicById(topic_id, function (err, topic, tags) {
    if (!topic) {
      res.render404('This topic does not exist or has been deleted.');
      return;
    }
    ...
    if (String(topic.author_id) === String(req.session.user._id) || req.session.user.is_admin) {
      ...
      res.renderError('Sorry, you cannot edit this topic.', 403);
    }
  });
};
...
exports.delete = function (req, res, next) {
  ...
  Topic.getFullTopic(topic_id, function (err, err_msg, topic, author, replies) {
    ...
    topic.save(function (err) {
      ...
      res.send({ success: true, message: 'This topic has been deleted.' });
    });
  });
};
...
exports.top = function (req, res, next) {
  ...
  Topic.getTopic(topic_id, function (err, topic) {
    ...
    topic.save(function (err) {
      ...
      var msg = topic.top ? 'This topic is placed at the top.' : 'This topic has been removed from the top.';
...
exports.good = function (req, res, next) {
  ...
  Topic.getTopic(topicId, function (err, topic) {
    ...
    topic.save(function (err) {
      ...
      var msg = topic.good ? 'This topic adds to digest.' : 'This topic has been removed from digest.';
      res.render('notify/notify', {success: msg, referer: referer});
    });
  });
};
...
exports.lock = function (req, res, next) {
  ...
  Topic.getTopic(topicId, function (err, topic) {
    ...
    topic.save(function (err) {
      ...
      var msg = topic.lock ? 'This topic is locked.' : 'This topic has been unlocked';
      res.render('notify/notify', {success: msg, referer: referer});
    });
  });
};
